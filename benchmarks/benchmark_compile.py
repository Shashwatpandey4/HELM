...
GEN_LENGTH = 128
WARMUP_ITER = 3 # Increased for torch.compile
BENCHMARK_ITER = 10
...
def run_suite(model, tokenizer, scenario_name, prompt_config):
    ...
    for bs in BATCH_SIZES:
        ...
        # Compilation & Warmup
        # Compilation happens on the first call
        ...
        # We run several times to ensure compilation is done
        print(f"Compiling/Warmup for BS={bs}...", end="\r")
...
def benchmark():
    ...
    print("\nStarting Benchmark Suite (torch.compile)")
